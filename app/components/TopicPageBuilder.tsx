...
import { Calendar, Clock, Tag, ArrowLeft, ExternalLink, Github, Brain } from 'lucide-react';
import Link from 'next/link';
import CodeBlock from './CodeBlock';

interface TopicBlock {
  type: 'heading' | 'paragraph' | 'list' | 'image' | 'codeBlock' | 'section' | 'highlight' | 'twoColumn' | 'timeline' | 'features';
  content?: string;
  ...
  switch (block.type) {
    ...
    case 'list':
      ...
      const listClass = isOrdered 
        ? 'list-decimal list-inside space-y-2 text-slate-700 dark:text-slate-300 mb-6 ml-4'
        : 'list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 mb-6 ml-4';

import { Layers, Zap, Brain, Target, Eye, ArrowRightLeft } from 'lucide-react';
...
export default function TransformerPage() {
  return <TopicPageBuilder {...transformerData} />;
}

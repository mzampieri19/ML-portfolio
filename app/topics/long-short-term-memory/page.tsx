import { Database, Shield, Brain, Clock, Zap, Target } from 'lucide-react';
      ...
      children: [
        {
          ...
          children: [
            {
              type: 'paragraph' as const,
              content: "Forget Gate: f_t = σ(W_f · [h_{t-1}, x_t] + b_f)\nInput Gate: i_t = σ(W_i · [h_{t-1}, x_t] + b_i)\nCandidate: C̃_t = tanh(W_C · [h_{t-1}, x_t] + b_C)\nCell State: C_t = f_t * C_{t-1} + i_t * C̃_t\nOutput Gate: o_t = σ(W_o · [h_{t-1}, x_t] + b_o)\nHidden State: h_t = o_t * tanh(C_t)\n\nWhere σ is the sigmoid function"
            }
          ]
        }
      ]
      ...
      children: [
        {
          ...
          children: [
            {
              type: 'list' as const,
              content: "Solves vanishing gradient problem\nCan learn long-term dependencies\nBetter at selective memory\nMore stable training"
            }
          ]
        },
        {
          ...
          children: [
            {
              type: 'list' as const,
              content: "More complex architecture\nHigher computational cost\nMore parameters to train\nSlower than simple RNNs"
            }
          ]
        }
      ]
...
export default function LSTMPage() {
  return <TopicPageBuilder {...lstmData} />;
}

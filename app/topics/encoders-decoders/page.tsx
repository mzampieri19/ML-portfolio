import { Archive, Expand, Brain, ArrowRightLeft, Code, Image } from 'lucide-react';
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              type: 'list' as const,
              content: "Machine translation between languages\nText summarization and generation\nChatbots and conversational AI\nCode generation and programming assistance"
            }
          ]
        }
      ]
...
export default function EncoderDecoderPage() {
  return <TopicPageBuilder {...encoderDecoderData} />;
}

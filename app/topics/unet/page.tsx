import { Layers, ArrowUpDown, Brain, Image, Target, Zap } from 'lucide-react';
      ...
      children: [
        {
          ...
          children: [
            {
              type: 'list' as const,
              content: "Medical image segmentation (organs, tumors)\nSatellite image analysis\nObject detection and localization\nImage inpainting and restoration"
            }
          ]
        },
        {
...
export default function UNetPage() {
  return <TopicPageBuilder {...unetData} />;
}

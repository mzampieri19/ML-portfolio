import { Waves, Brain, Clock, Zap, Target, Camera } from 'lucide-react';
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              type: 'paragraph' as const,
              content: "p_θ(x_{t-1} | x_t) = N(x_{t-1}; μ_θ(x_t, t), Σ_θ(x_t, t))\n\nThe neural network learns to predict μ_θ (mean) and optionally Σ_θ (variance)"
            }
          ]
        }
      ]
...
export default function DDPMPage() {
  return <TopicPageBuilder {...ddpmData} />;
}

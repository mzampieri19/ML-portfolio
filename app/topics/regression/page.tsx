import { TrendingUp, BarChart3, Target, LineChart, Brain, Calculator } from 'lucide-react';
      ...
      children: [
        {
          ...
          children: [
            {
              type: 'list' as const,
              content: "R² Score: Proportion of variance explained\nMean Squared Error (MSE): Average squared differences\nMean Absolute Error (MAE): Average absolute differences\nRoot Mean Squared Error (RMSE): Square root of MSE"
            }
          ]
        },
        {
          ...
          children: [
            {
              type: 'list' as const,
              content: "Linearity: Relationship between variables is linear\nIndependence: Observations are independent\nHomoscedasticity: Constant variance of residuals\nNormality: Residuals are normally distributed"
            }
          ]
        }
      ]
...
export default function RegressionPage() {
  return <TopicPageBuilder {...regressionData} />;
}

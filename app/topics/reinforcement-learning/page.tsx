import { Gamepad2, Brain, Target, TrendingUp, Zap, BarChart3, Settings, Trophy } from 'lucide-react';
...
def ucb_action(q_values, counts, t, c=2):
    ...
    },
    {
      ...
      children: [
        {
          type: 'paragraph' as const,
          content: "Explore these resources to deepen your understanding of Reinforcement Learning:"
        },
        {
          type: 'twoColumn' as const,
          props: {
                  ...
                  features: [
                    {
                      ...
                      description: "Sutton & Barto - the definitive RL textbook"
                    },
                    {
                      icon: <Trophy className="w-6 h-6" />,
                      title: "Playing Atari with Deep RL",
                      description: "DeepMind's DQN paper (Mnih et al., 2013)"
                    },
                    {
                      icon: <Trophy className="w-6 h-6" />,
                      title: "Mastering the Game of Go",
                      description: "AlphaGo paper by Silver et al. (2016)"
                    }
                  ],
                  columns: 1
                }
                  ...
                  features: [
                    {
                      icon: <Trophy className="w-6 h-6" />,
                      title: "OpenAI Gym",
                      description: "Standard RL environment toolkit"
                    },
                    {
                      icon: <Trophy className="w-6 h-6" />,
                    ...
                    },
                    {
                      icon: <Trophy className="w-6 h-6" />,
                      title: "DeepMind Lab",
                      description: "3D learning environments for agents"
                    }
                  ],
                  columns: 1
                }
